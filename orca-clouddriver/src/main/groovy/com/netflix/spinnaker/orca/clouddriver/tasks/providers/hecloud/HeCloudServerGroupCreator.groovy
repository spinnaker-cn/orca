...
@Slf4j
@Component
class HeCloudServerGroupCreator implements ServerGroupCreator, DeploymentDetailsAware {

  boolean katoResultExpected = true
  String cloudProvider = "hecloud"
...
//    }
    ...
    log.info("Deploying Hecloud ${operation.imageId} to ${operation.region}")
