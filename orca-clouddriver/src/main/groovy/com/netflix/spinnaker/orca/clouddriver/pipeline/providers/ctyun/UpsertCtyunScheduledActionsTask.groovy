...
@Component
class UpsertCtyunScheduledActionsTask implements Task {
  ...
  TaskResult execute(Stage stage) {
    def taskId = kato.requestOperations([[upsertCtyunScheduledActionsDescription: stage.context]])
        .toBlocking()
        .first()
    ...
    new TaskResult(ExecutionStatus.SUCCEEDED, [
        "notification.type"     : "upsertctyunscheduledactions",
