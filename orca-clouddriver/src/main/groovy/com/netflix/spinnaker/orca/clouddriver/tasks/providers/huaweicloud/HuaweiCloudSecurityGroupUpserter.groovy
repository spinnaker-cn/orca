...
@Slf4j
@Component
class HuaweiCloudSecurityGroupUpserter implements SecurityGroupUpserter, CloudProviderAware {
  ...
  boolean isSecurityGroupUpserted(MortService.SecurityGroup upsertedSecurityGroup, Stage _) {
    log.info("Enter huaweicloud isSecurityGroupUpserted with ${upsertedSecurityGroup.properties}")
    try {
