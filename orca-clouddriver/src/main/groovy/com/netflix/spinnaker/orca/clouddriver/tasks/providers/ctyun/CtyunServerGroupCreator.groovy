...
@Slf4j
@Component
class CtyunServerGroupCreator implements ServerGroupCreator, DeploymentDetailsAware {

  boolean katoResultExpected = true
  String cloudProvider = "ctyun"
...
//    }
    ...
    log.info("Deploying ctyun ${operation.imageId} to ${operation.region}")
