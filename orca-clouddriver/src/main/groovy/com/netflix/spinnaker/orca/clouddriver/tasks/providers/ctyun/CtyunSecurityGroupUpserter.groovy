...
@Slf4j
@Component
class CtyunSecurityGroupUpserter implements SecurityGroupUpserter, CloudProviderAware {
  ...
  boolean isSecurityGroupUpserted(MortService.SecurityGroup upsertedSecurityGroup, Stage _) {
    log.info("Enter ctyun isSecurityGroupUpserted with ${upsertedSecurityGroup.properties}")
    try {
