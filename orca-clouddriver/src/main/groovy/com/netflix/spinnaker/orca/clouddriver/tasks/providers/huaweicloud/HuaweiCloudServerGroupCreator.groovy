...
@Slf4j
@Component
class HuaweiCloudServerGroupCreator implements ServerGroupCreator, DeploymentDetailsAware {

  boolean katoResultExpected = true
  String cloudProvider = "huaweicloud"
...
//    }
    ...
    log.info("Deploying huaweicloud ${operation.imageId} to ${operation.region}")
